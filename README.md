<p align="center" width="100%">
    <img height="100" src="https://github.com/Aakasha063/developer-portfolio/assets/77630868/c0064908-cd5f-4751-a77c-eba90a62b55c">
</p>

---

# [Built Portfolio With GitHub ](https://github.com/Aakasha063/github-portfolio)
...
## View live preview [here](https://aakashaggarwal.netlify.app/).
...
```bash
git clone https://github.com/Aakasha063/developer_portfolio.git
...
### Then, Customize data in the `utils/data` [folder](https://github.com/Aakasha063/developer-portfolio/tree/main/utils/data).
...
export const personalData = {
  ...
  description: "I am Aakash Aggarwal....",
  email: "aakasha063@gmail.com",
  phone: "+918685851664",
  address: "Panchkula, Haryana",
  github: "https://github.com/Aakasha063",
  facebook: "https://www.facebook.com/aakash.aggarwal.1048",
  linkedIn: "https://www.linkedin.com/in/aakash-aggarwal03/",
  twitter: "https://x.com/AakashAggr",
  stackOverflow: "https://stackoverflow.com/users/16840768/abu-said",
  leetcode: "https://leetcode.com/said3812/",
  devUsername: "aakasha063",
  resume: "...",
};
```
